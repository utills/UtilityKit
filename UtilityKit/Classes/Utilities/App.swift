...
//  UtilityKit
//
//  Created by Vivek Kumar on 02/01/19.
//

import UIKit
public class App {
    public static let shared = App()
    public static let appName = getName()
    public static let countryCode = Locale.current.regionCode
    public static let countryDialCode = App.dialCode()
    var topViewController:UIViewController?{
        get{
            return App.presentedController()
        }
    }
    
    public class func getName() -> String {
        if let appName =  Bundle.main.infoDictionary?["CFBundleDisplayName" as String] as? String{
            return appName
        }else{
            return ""
        }
    ...
    public class func presentedController() -> UIViewController? {
    ...
    public class func dialCode()->String?{
        ...
        return countryDictionary[App.countryCode ?? ""]
    }
